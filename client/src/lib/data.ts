...
export const EV_STATIONS: ChargingStation[] = [
  ...
  },
  {
    ...
    availableSlots: 8,
    chargerTypes: [
      { type: "DC콤보", count: 6, maxKw: 200, available: 4 },
      { type: "AC완속", count: 6, maxKw: 7, available: 4 },
    ],
    operatingHours: "24시간 운영",
  ...
  },
  {
    ...
    availableSlots: 3,
    chargerTypes: [
      { type: "DC콤보", count: 8, maxKw: 100, available: 2 },
      { type: "AC완속", count: 2, maxKw: 7, available: 1 },
    ],
    operatingHours: "24시간 운영",
    photo: "https://private-us-east-1.manuscdn.com/sessionFile/CL30WOLd8pbCUpEbYPccwp/sandbox/EAyGbMG1FHjp60bisLUYbi-img-1_1771996924000_na1fn_ZXYtc3RhdGlvbi1waG90bw.jpg",
  ...
  },
  {
    ...
    availableSlots: 0,
    chargerTypes: [
      { type: "DC콤보", count: 2, maxKw: 50, available: 0 },
      { type: "AC완속", count: 2, maxKw: 7, available: 0 },
    ],
  ...
  },
  {
    ...
    chargerTypes: [
      { type: "DC콤보", count: 4, maxKw: 100, available: 3 },
      { type: "AC완속", count: 4, maxKw: 7, available: 3 },
    ],
    operatingHours: "24시간 운영",
    photo: "https://private-us-east-1.manuscdn.com/sessionFile/CL30WOLd8pbCUpEbYPccwp/sandbox/EAyGbMG1FHjp60bisLUYbi-img-1_1771996924000_na1fn_ZXYtc3RhdGlvbi1waG90bw.jpg",
    rating: 4.2,
  ...
  },
  {
    ...
    availableSlots: 2,
    chargerTypes: [
      { type: "DC콤보", count: 2, maxKw: 200, available: 1 },
      { type: "AC완속", count: 8, maxKw: 7, available: 1 },
    ],
  ...
  },
  {
    ...
    availableSlots: 0,
    chargerTypes: [
      { type: "DC콤보", count: 3, maxKw: 100, available: 0 },
      { type: "AC완속", count: 3, maxKw: 7, available: 0 },
    ],
  ...
  {
    id: "stn-015",
    name: "금천구청역 자전거주차장 인근",
    address: "서울 금천구 시흥대로63길 32",
    lat: 37.4555,
    lng: 126.8938,
    status: "available",
    totalSlots: 4,
    availableSlots: 3,
    chargerTypes: [
      { type: "DC콤보", count: 2, maxKw: 50, available: 1 },
      { type: "AC완속", count: 2, maxKw: 7, available: 2 },
    ],
    operatingHours: "24시간 운영",
    photo: "https://private-us-east-1.manuscdn.com/sessionFile/CL30WOLd8pbCUpEbYPccwp/sandbox/EAyGbMG1FHjp60bisLUYbi-img-1_1771996924000_na1fn_ZXYtc3RhdGlvbi1waG90bw.jpg",
  ...
  },
  {
    ...
    availableSlots: 5,
    chargerTypes: [
      { type: "AC완속", count: 5, maxKw: 7, available: 5 },
    ],
    operatingHours: "24시간 운영",
    photo: "https://private-us-east-1.manuscdn.com/sessionFile/CL30WOLd8pbCUpEbYPccwp/sandbox/EAyGbMG1FHjp60bisLUYbi-img-1_1771996924000_na1fn_ZXYtc3RhdGlvbi1waG90bw.jpg",
    rating: 4.0,
